...
Pour poser une question, vous pouvez nous envoyer un mail à Anna (anna.smyk@insee.fr) et à moi (tanguy.barthelemy@insee.fr) ou remplir une issue directement sur GitHub.
Pour créer une issue sur GitHub, vous devez :
...
3. Choisissez l'un des thèmes proposés dans la liste et cliquez sur *Get started* :

<p align="center">
  <img src="https://github.com/TanguyBarthelemy/rr2024/blob/main/figures/issue/choose_issue.png?raw=true">


4. Remplissez l'issue avec un titre et un texte pour expliquer le problème ou la demande et cliquez sur *Submit new issue* :
